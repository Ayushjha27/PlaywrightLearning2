...
=> Hard/Normal assertion — expect()
If this assertion fails:
Remaining assertions/actions are NOT executed. This is the default behavior in Playwright.


=> Soft assertion — expect.soft(locator)
If it fails:
The test is still ultimately marked failed,but Playwright allows the remaining test steps/assertions
to execute.
